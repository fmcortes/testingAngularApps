...
describe('BookComponent', () => {
  ...
  it('should emit addTocaryt event', (done) => {
  ...
  it('should call to a function sendToCart when clicked', () => {
    ...
    let button = nativeElement.querySelector('.send-to-cart');
  ...
  it('should show the book description', () => {
    let description = nativeElement.querySelector('.book-description')
      .innerHTML;
  ...
  it('upvotes invkes the component function', () => {
